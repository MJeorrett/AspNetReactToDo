...
namespace Anrtd.Infrastructure.Migrations
{
    ...
    [Migration("20210307142611_AddToDoLists")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Anrtd.Domain.Entities.ToDoTagEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)")
                        .HasColumnName("ToDoTagId");
            ...
            modelBuilder.Entity("ToDoEntityToDoTagEntity", b =>
                {
                    ...
                    b.ToTable("ToDoEntityToDoTagEntity");
                });

            modelBuilder.Entity("Anrtd.Domain.Entities.ToDoEntity", b =>
                {
                    b.HasOne("Anrtd.Domain.Entities.ToDoListEntity", "List")
                        .WithMany("ToDos")
            ...
            modelBuilder.Entity("ToDoEntityToDoTagEntity", b =>
                {
                    b.HasOne("Anrtd.Domain.Entities.ToDoTagEntity", null)
                        .WithMany()
                        .HasForeignKey("TagsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Anrtd.Domain.Entities.ToDoEntity", null)
                        .WithMany()
